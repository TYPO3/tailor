...
__Overview of all available commands__
| __Methods__           | __Arguments__                     | __Options__                                                                               | __Description__                                 |
| --------------------- | --------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------- |
| ``ter:delete``        | ``extensionkey``                  | ``composer``<br/>``version``                                                              | Delete an extension.                            |
